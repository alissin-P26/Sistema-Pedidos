...
public class ListEstado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Dê dois cliques no registro para editá-lo.");

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Consulta Estado");
        ...
        jcbTipoFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "TODOS", "ID", "PAÍS", "NOME", "UF", " " }));
